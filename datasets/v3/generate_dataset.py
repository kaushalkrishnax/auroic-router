"""
Auroic Router Dataset Generator v6
====================================
7000 samples | Semantic deduper (sentence-transformers) | Distribution enforcer
Canonical titles | Adversarial early-targets | Multi-signal context
Implicit intents for media/react | Effort on all types except ignore
Compact .txt output → separate compact_to_jsonl.py for training JSONL
"""
...
try:
    ...
    _HAS_FAKER = False
    print("⚠️  faker not found, using static names only")
...
CONVERSATION_MEMORY_COUNT = 350   # ~350 coherent conversation flow samples
CPA_PERMUTATIONS = 2              # permutations per sample for Context Permutation Augmentation
...
HI_FILLERS = [
    ...
    # ── v6 additions ──
    "toh","phir","kaise","kab","kidhar","dikha","batao na","suno bhai",
    "haan ji","nahi ji","ekdum","pakka","zaroor","koi baat nahi","ho jayega",
    "chhodo","jaane do","rehne do","chup","sab theek","tension mat le",
    "kya farak padta","mujhe kya","tujhe kya lagta","bhai sahab","boss",
    "bhai please","yaar please","ek sec","ruk ja","baith","chal hat",
    "jhooth mat bol","kasam se","sach bol raha","maan le","sun toh sahi",
    "dekh le","kar le","hota hai","normal hai","aisa hota hai","koi nahi",
    "arey wah","kya baat","mast","zabardast","badhiya","shandar","kamaal",
    "bakwas","faltu","bekaar","bekar","wahiyat","ghatiya","chalo koi nahi",
]
...
SLANG_FILLERS = [
    ...
    "spill","rent free","main character","delulu","its giving","understood the assignment",
...
# ═══════════════════════════════════════════════════════════════════════════════
# IMPLICIT INTENT BOUNDARY RULE:
#   NO question word (kya karun, how do i, help) = media or react
#   Question word present (kya karun, kaise, help me, guide) = text
# This is the key distinction between media/react and text types.
# ═══════════════════════════════════════════════════════════════════════════════

# MEDIA_TOPICS — implicit situational (NO explicit "send gif/meme/bhej")
# The message describes a SITUATION; the router infers media response is appropriate.
# Structure: {category: [(situational_msg, canonical_title, effort), ...]}
MEDIA_TOPICS = {
    "funny_moment": [
        ("teacher ne galti se apni dating app screen share kar di class mein 😂","media:funny_moment","medium"),
        ("yaar aaj office mein chair toot gayi meeting mein boss gir gaya","media:funny_moment","medium"),
        ("bhai autocorrect ne itna embarrassing msg bhej diya crush ko 😭","media:funny_moment","low"),
        ("cafeteria mein tray le ke ja raha tha pura gir gaya sabke saamne","media:funny_moment","low"),
        ("yaar teacher ne apna tiktok accidentally projector pe chala diya","media:funny_moment","medium"),
        ("bhai galti se group mein personal msg chala gaya sabne dekh liya","media:funny_moment","low"),
        ("presentation mein slide galat lag gayi meme wali sab hase bhai","media:funny_moment","medium"),
        ("bhai aaj interview mein itna funny hua imagine karo","media:funny_moment","high"),
    ],
    "comfort": [
        ("bahut down feel ho raha hai aaj kuch accha nahi lag raha","media:comfort","low"),
        ("yaar bahut lonely lag raha hai aaj sab busy hain","media:comfort","low"),
        ("mood off hai poora din kharab gaya aaj bhai","media:comfort","low"),
        ("bhai bahut stressed hai aaj kuch bhi sahi nahi ho raha","media:comfort","medium"),
        ("feeling really low today everything went wrong ngl","media:comfort","low"),
        ("yaar din bhar ro raha tha kuch nahi ho raha sahi","media:comfort","medium"),
    ],
    "celebration": [
        ("bhai aaj birthday hai mera turning 21 finally adult","media:celebration","high"),
        ("yaar engagement ho gayi bhai ring de diya usne","media:celebration","high"),
        ("exam clear ho gaya bhai sabse mushkil wala paper","media:celebration","medium"),
        ("job offer aa gaya bhai finally placement ho gayi","media:celebration","high"),
        ("bhai anniversary hai aaj humari ek saal ho gaya","media:celebration","medium"),
        ("visa approve ho gaya bhai dream country ja raha hun","media:celebration","high"),
        ("finally driving license mil gaya bhai kaafi try ke baad","media:celebration","medium"),
    ],
    "food_craving": [
        ("yaar pizza ki craving ho rahi hai bahut badly right now","media:food_craving","low"),
        ("bhai biryani ki yaad aa rahi hai mummy wali ghar ki","media:food_craving","low"),
        ("burger dekhke muh mein paani aa gaya bhai acidity","media:food_craving","low"),
        ("yaar momos khaane ka mann kar raha hai bahut zyada","media:food_craving","low"),
        ("chai ki craving hai bhai barish mein pakode ke saath","media:food_craving","low"),
    ],
    "gaming_hype": [
        ("bhai valorant mein ace maar diya just now insane tha","media:gaming_hype","medium"),
        ("clutch maar diya 1v5 bhai sabne dekha lobby mein","media:gaming_hype","high"),
        ("yaar new skin mila battle pass se legendary wala","media:gaming_hype","low"),
        ("bhai minecraft mein itna insane build banaya finally","media:gaming_hype","medium"),
        ("ranked mein diamond hit kar liya bhai grind paid off","media:gaming_hype","medium"),
        ("triple kill liya bhai last round mein carry kiya","media:gaming_hype","medium"),
    ],
    "cute_animal": [
        ("yaar aaj road pe stray puppy mila bahut cute tha","media:cute_animal","low"),
        ("bhai meri billi ne kuch aisa kiya aaj too cute","media:cute_animal","low"),
        ("neighbours ka dog pajama mein tha bhai too adorable","media:cute_animal","low"),
        ("yaar parrot bol raha tha hello uncle toh mein mar gaya","media:cute_animal","low"),
        ("bhai kitten ne pehli baar aankhein kholi so precious","media:cute_animal","low"),
    ],
    "aesthetic_vibe": [
        ("yaar bahar itni amazing barish ho rahi hai cozy vibes","media:aesthetic_vibe","low"),
        ("bhai sunset dekha aaj se balcony itna beautiful tha","media:aesthetic_vibe","low"),
        ("fog itni thick hai aaj morning mein silent hill vibes","media:aesthetic_vibe","low"),
        ("yaar raat ko taarein dikh rahe hain rooftop se amazing","media:aesthetic_vibe","low"),
        ("bhai snowfall ho rahi hai pehli baar dekh raha hun live","media:aesthetic_vibe","medium"),
    ],
    "hype_moment": [
        ("bhai naya trailer drop hua movie ka insane lag raha","media:hype_moment","medium"),
        ("yaar concert mein front row mil gayi bhai maza aayega","media:hype_moment","high"),
        ("new phone aa gaya bhai unboxing abhi ki brand new","media:hype_moment","medium"),
        ("bhai bike leli nayi pehli ride pe ja raha bhai","media:hype_moment","high"),
        ("yaar ipl ka ticket mila stadium mein dekhenge live","media:hype_moment","high"),
        ("bhai sneakers mila limited edition wala finally drop mein","media:hype_moment","medium"),
    ],
}

# REACT_TOPICS — natural moments that deserve emoji reactions
# Structure: {emoji: [(situational_msg, effort), ...]}
REACT_TOPICS = {
    "🥳": [
        ("bhai placement ho gayi campus se finally done","high"),
        ("result aa gaya bhai first class with distinction","high"),
        ("yaar shaadi ki date fix ho gayi bhai december mein","high"),
        ("got accepted into masters program abroad bhai","high"),
        ("bhai startup ko funding mil gayi investors aaye","high"),
    ],
    "🔥": [
        ("bhai clutch maar diya valorant mein 1v5 insane","medium"),
        ("aaj gym mein deadlift PR tod diya new max hit","medium"),
        ("yaar presentation itni acchi gayi standing ovation","medium"),
        ("code review mein senior ne bola perfect implementation","medium"),
        ("bhai cricket mein hatrick le li gully cricket but still","medium"),
    ],
    "😂": [
        ("bhai teacher ne galti se apna phone connect kar diya projector se","low"),
        ("yaar auto wale ne itna funny bola aaj ride mein","low"),
        ("landlord ka message galti se group mein aa gaya embarrassing","low"),
        ("bhai friend ne wrong person ko i love you bhej diya","low"),
        ("yaar cafeteria mein sabke saamne gir gaya tray ke saath","low"),
    ],
    "😱": [
        ("yaar road pe almost accident hote hote bacha barely","high"),
        ("bhai earthquake aa gayi yaar itna dar gaya tha abhi","high"),
        ("phone gir gaya 5th floor se somehow screen nahi tooti","medium"),
        ("yaar wallet chori ho gaya metro mein pata nahi kab","high"),
        ("bhai snake dikha room mein yaar darr gaya bhai","high"),
    ],
    "💪": [
        ("bhai gym mein personal record tod diya aaj finally","medium"),
        ("marathon complete kiya yaar pehli baar 10k run","medium"),
        ("finally roz subah uthne ki aadat lag gayi 30 din ho gaye","low"),
        ("yaar smoking chhod di bhai 3 mahine ho gaye clean","medium"),
        ("cold shower le raha hun roz ab discipline aa gaya","low"),
    ],
    "😭": [
        ("yaar pet billi mar gayi bhai 8 saal se thi humare paas","high"),
        ("bhai best friend dusre sheher shift ho gaya permanently","medium"),
        ("series khatam ho gayi yaar ab kya dekhu void feel","low"),
        ("bhai last day tha college ka itna emotional ho gaya","medium"),
        ("grandparents ki photo mili purani bahut miss karta hun","medium"),
    ],
    "🎉": [
        ("bhai baby aa gaya ghar mein naya member welcome","high"),
        ("visa approve ho gaya bhai canada ja raha hun","high"),
        ("yaar internship confirm ho gayi google mein bhai","high"),
        ("new house mein shift ho gaye bhai griha pravesh done","high"),
        ("bhai youtube pe 10K subscribers cross ho gaye","medium"),
    ],
    "❤️": [
        ("yaar dost ne surprise birthday party plan ki thi emotional","medium"),
        ("bhai mummy ne favourite khana banaya bina bole samajh gayi","low"),
        ("friend ne 3 baje uthke help kiya exam ke liye true friend","medium"),
        ("yaar purana school friend mila aaj itne saalon baad","medium"),
        ("bhai dog mera intezaar kar raha tha gate pe jab aaya","low"),
    ],
    "😎": [
        ("bhai promotion mil gayi salary 40 percent hike bhai","high"),
        ("interview crack kiya first attempt mein no prep needed","medium"),
        ("yaar coding competition mein first rank aaya bhai","medium"),
        ("boss ne bola tu team lead banega ab se bhai","high"),
        ("bhai freelance client ne bonus de diya happy with work","medium"),
    ],
    "🌧️": [
        ("bhai pehli barish aayi monsoon shuru ho gaya finally","low"),
        ("yaar poori raat barish hui itna peaceful tha sonna","low"),
        ("thunderstorm aa rahi hai bhai lightning dikh rahi","low"),
    ],
    "💀": [
        ("that meme format is absolutely perfect timing im dead","low"),
        ("bhai itna cringe tha ki mar gaya dekhke literally","low"),
        ("yaar teacher ka ye joke sunke class mein sannata tha","low"),
        ("autocorrect ne itna galat bheja ki mein mar gaya bhai","low"),
    ],
}

ACKNOWLEDGE_TOPICS = [
    # (key_msg, reply_pool, effort)
    ("bhai kaam ho gaya assignment submit kar diya finally",["noted done","well done bhai","great job","nicely done","proud of you"],"medium"),
    ("i reached home safely just got here now all good",["glad youre safe","safe travels","take rest now","good to know","relieved"],"high"),
    ("bhai payment kar diya upi se transfer hua confirm",["payment received","confirmed got it","noted thanks","received","all good"],"high"),
    ("good morning bhai subah subah gm everyone rise up",["good morning","gm bhai","rise and shine","morning vibes","gm to you too"],"low"),
    ("bhai bohot shukriya mera kaam kar diya tune thanks",["youre welcome","anytime yaar","happy to help","no problem bhai","always here"],"low"),
    ("just sent you the document check your email inbox",["got it thanks","received noted","got the file","thank you","acknowledged"],"medium"),
    ("bhai so jaata hun good night everyone gn sweet dreams",["good night","sleep well bhai","gn sweet dreams","rest well","gn take care"],"low"),
    ("i am really sorry about what happened yaar my bad",["its okay bhai","apology accepted","all good now","no worries","we are good"],"medium"),
    ("bhai update sun progress update de raha hun project",["got the update","noted thanks","understood bhai","got it","thanks for update"],"medium"),
    ("bhai tabiyat theek nahi hai fever hai mujhe aaj sick",["get well soon","rest up bhai","take care yaar","feel better soon","rest karo"],"high"),
    ("reached the hospital safely waiting outside for doc",["okay stay strong","good to know","keep us updated","take care","with you always"],"high"),
    ("bhai file share kar di check karo please google drive",["got the file","received thanks","checking now","noted","got it bhai"],"medium"),
    ("just finished the presentation nailed it hopefully",["fingers crossed","you did great","all the best","proud of you","hope it went well"],"medium"),
    ("bhai ghar aa gaya safely trip mast rahi enjoyed alot",["glad youre safe","rest kar ab","welcome back","happy to hear","take rest"],"medium"),
    ("thanks for being there always appreciate it bro really",["always here for you","anytime bro","that is what friends are for","always","no problem"],"low"),
    ("bhai interview de ke aaya accha laga mujhe went well",["fingers crossed bhai","inshallah ho jayega","all the best","hope it went well","proud of you"],"medium"),
    ("submitted the project before deadline finally done yaar",["great job bhai","well done","proud of you","nicely done","you did it"],"medium"),
    ("bhai neend aa rahi hai kal milte hain gn sweet dreams",["gn bhai","kal milte hain","sweet dreams","good night","rest well"],"low"),
    ("food is ready come eat everyone at table khana ready",["coming now","on my way","be right there","just a min","coming"],"low"),
    ("bhai movie download ho gayi link bhej raha hun check",["got it thanks","received the link","downloading now","thanks bhai","got it"],"medium"),
    # ── v6 additions ──
    ("bhai parcel aa gaya delivery ho gayi check karo gate pe",["got it thanks","coming down","noted","on my way","thanks for telling"],"medium"),
    ("yaar meeting cancel ho gayi boss ne postpone kar diya",["okay noted","fine then","got it","cool free time","understood"],"low"),
    ("bhai reservation confirm ho gayi dinner ke liye 8 baje",["perfect noted","awesome","see you there","great","looking forward"],"medium"),
    ("yaar cab book kar li 15 min mein aayegi ready raho",["okay ready","got it","coming down","noted","will be ready"],"medium"),
    ("bhai wifi ka password change kiya new one is in notes",["got it thanks","noted","will update","thanks","okay updating"],"low"),
]

TRANSLATE_TOPICS = [
    # (foreign_text, canonical_title, effort)
    ("Muchas gracias por tu ayuda amigo de verdad","translate:spanish_text","low"),
    ("No entiendo nada de lo que dijiste ahora","translate:spanish_text","low"),
    ("Por favor ayudame con esto es urgente hoy","translate:spanish_text","high"),
    ("Estoy muy emocionado por lo que paso hoy","translate:spanish_text","low"),
    ("No se que hacer en esta situacion ahora mismo","translate:spanish_text","medium"),
    ("Me alegra mucho verte despues de tanto tiempo","translate:spanish_text","low"),
    ("Esto es absolutamente increible no puedo creer","translate:spanish_text","low"),
    ("Te quiero mucho amigo siempre estaras en mi corazon","translate:spanish_text","low"),
    ("Feliz cumpleanos espero que tengas un dia maravilloso","translate:spanish_text","low"),
    ("El examen fue muy dificil pero creo que lo pase","translate:spanish_text","medium"),
    ("ありがとうございました本当に助かりました","translate:japanese_text","low"),
    ("お疲れ様でした今日もよく頑張りましたね","translate:japanese_text","low"),
    ("よろしくお願いしますこれからもよろしく","translate:japanese_text","medium"),
    ("すみません少し助けていただけますか","translate:japanese_text","medium"),
    ("わかりました了解です問題ありません","translate:japanese_text","low"),
    ("頑張ってください応援していますよ","translate:japanese_text","low"),
    ("おはようございます今日もよい一日を","translate:japanese_text","low"),
    ("おやすみなさいゆっくり休んでください","translate:japanese_text","low"),
    ("本当に嬉しいです信じられないくらいです","translate:japanese_text","low"),
    ("また会いましょうそれまでお元気で","translate:japanese_text","low"),
    ("감사합니다 정말 도움이 많이 됐어요","translate:korean_text","low"),
    ("안녕하세요 처음 뵙겠습니다 잘 부탁드려요","translate:korean_text","medium"),
    ("사랑해요 항상 곁에 있어줘서 고마워요","translate:korean_text","low"),
    ("미안해요 제가 잘못했어요 용서해 주세요","translate:korean_text","medium"),
    ("정말 대단해요 어떻게 그렇게 잘 하세요","translate:korean_text","low"),
    ("화이팅 할 수 있어요 믿어요","translate:korean_text","low"),
    ("배고파요 뭔가 맛있는 거 먹고 싶어요","translate:korean_text","low"),
    ("오늘 정말 힘든 하루였어요 지쳐버렸어요","translate:korean_text","low"),
    ("Merci beaucoup pour tout ce que tu as fait","translate:french_text","low"),
    ("Je ne comprends pas du tout ce que tu veux dire","translate:french_text","medium"),
    ("Sil vous plait aidez moi cest vraiment urgent","translate:french_text","high"),
    ("Cest tres interessant je naurais pas pense a ca","translate:french_text","low"),
    ("Je suis desole pour ce qui sest passe hier","translate:french_text","low"),
    ("Bonne chance pour demain je suis avec toi","translate:french_text","low"),
    ("Comment ca va depuis la derniere fois quon sest vus","translate:french_text","low"),
    ("Au revoir et a bientot prends soin de toi","translate:french_text","low"),
    ("شكراً جزيلاً على مساعدتك لي اليوم","translate:arabic_text","low"),
    ("لا أفهم هذا الكلام أبداً وضح لي من فضلك","translate:arabic_text","medium"),
    ("من فضلك ساعدني في هذا الأمر المهم","translate:arabic_text","high"),
    ("أنا سعيد جداً بما حدث اليوم الحمد لله","translate:arabic_text","low"),
    ("هذا رائع جداً لم أكن أتوقع هذا أبداً","translate:arabic_text","low"),
    ("كيف حالك اليوم أتمنى أن تكون بخير دائماً","translate:arabic_text","low"),
    ("مع السلامة وإلى اللقاء قريباً إن شاء الله","translate:arabic_text","low"),
    ("Vielen Dank fuer deine Hilfe das war sehr nett","translate:german_text","low"),
    ("Ich verstehe das wirklich nicht erklaer mir das bitte","translate:german_text","medium"),
    ("Bitte hilf mir dabei ich schaffe es alleine nicht","translate:german_text","high"),
    ("Das ist wirklich sehr interessant hab ich nicht gewusst","translate:german_text","low"),
    ("Es tut mir sehr leid fuer das was passiert ist","translate:german_text","low"),
    ("Wie geht es dir ich hoffe du bist gesund heute","translate:german_text","low"),
    ("Muito obrigado pela sua ajuda foi fundamental hoje","translate:portuguese_text","low"),
    ("Nao entendo nada do que esta acontecendo aqui","translate:portuguese_text","medium"),
    ("Por favor me ajuda com isso eh muito urgente","translate:portuguese_text","high"),
    ("Estou muito feliz com tudo que aconteceu hoje","translate:portuguese_text","low"),
    ("آپ کا بہت بہت شکریہ آپ نے بہت مدد کی","translate:urdu_text","low"),
    ("مجھے سمجھ نہیں آیا ذرا سمجھائیں مہربانی","translate:urdu_text","medium"),
    ("برائے مہربانی میری مدد کریں بہت ضروری ہے","translate:urdu_text","high"),
    ("یہ بہت اچھا ہے واقعی بہت خوشی ہوئی آج","translate:urdu_text","low"),
    ("மிக்க நன்றி உங்கள் உதவிக்கு மிகவும் நன்றி","translate:tamil_text","low"),
    ("எனக்கு புரியவில்லை கொஞ்சம் விளக்கி சொல்லுங்கள்","translate:tamil_text","medium"),
    ("தயவுசெய்து உதவுங்கள் மிகவும் முக்கியமான விஷயம்","translate:tamil_text","high"),
    ("यार कल परीक्षा है कुछ नहीं पढ़ा अभी तक","translate:hindi_text","medium"),
    ("भाई बहुत थक गया हूं आज का दिन बुरा था","translate:hindi_text","low"),
    ("मुझे समझ नहीं आ रहा क्या करूं इस बारे में","translate:hindi_text","medium"),
]
...
# ═══════════════════════════════════════════════════════════════════════════════
# CONVERSATION MEMORY TOPICS — coherent multi-turn conversations
# ═══════════════════════════════════════════════════════════════════════════════

CONVERSATION_MEMORY_TOPICS = [
    # (msgs[5], type, target_idx_1indexed, effort, title)
    # -- Tech debugging flows (target=M1 initial request, later msgs are follow-up)
    (["bro python ka error aa raha","konsa error","indentation error","ohhh","koi fix pata hai kya"], "text", 1, "medium", "text:python_error"),
    (["bhai react mein error aa raha","kya error hai","usestate undefined","accha hooks ka issue hai","haan fix batao"], "text", 1, "medium", "text:react_error"),
    (["yaar docker mein kuch problem hai","kya hua","container start nahi ho raha","port conflict hoga","haan check karo"], "text", 1, "medium", "text:docker_error"),
    (["bhai git push karna hai","haan kar de","bhai conflict aa gaya","merge conflict hai","resolve kaise karu help"], "text", 5, "medium", "text:git_conflict"),
    (["yaar api call mar raha tha","okay","cors error aa raha hai","proxy lagao","kaise lagau proxy bata"], "text", 5, "medium", "text:cors_error"),
    (["bhai css kuch kaam nahi kar raha","kya hua","layout pura toot gaya","flexbox try kiya","nahi grid chahiye yaar"], "text", 1, "low", "text:css_layout"),
    (["bhai npm install kar raha tha","haan","dependency error aa gayi","node version check kar","bhai node 18 hai phir bhi"], "text", 1, "medium", "text:npm_error"),
    (["yaar firebase setup kar raha tha","okay","auth kaam nahi kar raha","google signin try kiya","haan bhai wo bhi fail"], "text", 1, "high", "text:firebase_auth"),
    (["bhai nextjs routing pe issue hai","kya problem hai exactly","page not found aa raha","file name check kar","bhai sab sahi hai phir bhi"], "text", 1, "medium", "text:nextjs_routing"),
    (["yaar mongodb connection fail ho raha","atlas hai ya local","atlas pe hai","ip whitelist kiya","haan bhai phir bhi nahi"], "text", 1, "medium", "text:mongodb_error"),
    # -- Study/exam conversations (target varies)
    (["bhai kal exam hai","konsa subject","physics","bohot padha","nahi yaar kuch nahi pada help"], "text", 5, "high", "text:exam_panic"),
    (["yaar assignment submit karni hai","deadline kab hai","aaj raat tak","kitna hua","bhai kuch nahi hua help karo"], "text", 5, "high", "text:assignment_help"),
    (["bhai notes chahiye class ke","konsi class","organic chemistry","mujhe bhi chahiye","bhai tere paas hain kya share kar"], "text", 1, "low", "text:notes_request"),
    (["yaar calculus samajh nahi aa raha","konsa topic","integration","youtube pe dekh","bhai link bhej koi accha wala"], "text", 1, "medium", "text:calculus_help"),
    (["bhai presentation banani hai","konse topic pe","startup ecosystem pe","slides kitni","bhai structure bata kaise banaun"], "text", 5, "medium", "text:presentation_help"),
    # -- Relationship conversations
    (["bhai crush ko msg kiya tha","kya bola usne","seen karke chhod diya","oof bhai","ab kya karu yaar help"], "text", 5, "low", "text:crush_advice"),
    (["yaar breakup ho gayi","kya hua","usne block kar diya","bhai stay strong","nahi yaar bahut bura lag raha"], "text", 1, "low", "text:breakup_support"),
    (["bhai best friend se fight ho gayi","kya hua batao","galat baat bola usne","sorry bol de","bhai main kyun bolun wo galat tha"], "text", 1, "low", "text:friendship_conflict"),
    (["yaar ex ne text kiya","kya likha usne","miss you likha","bhai reply mat kar","but yaar feelings aa gayi phir se"], "text", 5, "low", "text:ex_advice"),
    (["bhai parents pressure de rahe","kya ke liye","engineering join karne ko","tujhe kya karna hai","mujhe design karna hai but wo nahi maante"], "text", 1, "low", "text:family_pressure"),
    # -- Health conversations
    (["bhai sar mein bohot dard hai","kab se ho raha","subah se","paani piya","haan bhai phir bhi nahi ja raha"], "text", 1, "medium", "text:headache_remedy"),
    (["yaar neend nahi aa rahi","phone band kar","band kiya tha","melatonin try kar","bhai kuch natural remedy batao"], "text", 5, "low", "text:sleep_problem"),
    (["bhai gym jaana chhodh diya","kyun bhai","motivation nahi hai","workout partner dhoondh","bhai tujhe kaise milta motivation"], "text", 5, "low", "text:gym_motivation"),
    # -- Media request flow
    (["bhai kuch funny dekhna hai mood off hai","kya chahiye","meme ya gif kuch bhi","insta pe dekh","nahi bhai tu bhej na ek funny meme"], "media", 5, "medium", "media:funny_meme"),
    (["yaar bore ho raha hun","game khel","nahi kuch aur chahiye","movie dekh","bhai feeling down hai kuch funny chahiye"], "media", 5, "medium", "media:comfort"),
    (["bhai feeling low hai aaj","kya hua","kuch nahi bus mood nahi hai","ice cream kha","yaar bahut sad feel ho raha hai abhi"], "media", 5, "low", "media:comfort"),
    # -- React conversations
    (["bhai ek baat batau","haan bata","bhai selection ho gayi meri","konsi cheez mein","UPSC bhai UPSC clear kar liya"], "react", 5, "high", "🥳"),
    (["yaar sun na kuch hua","kya hua bata","bhai accident ho gaya","kya sach mein","haan bhai hospital mein hun"], "react", 3, "high", "😱"),
    (["bhai gaming tournament ki news","kya hua","bhai hum finals mein aa gaye","serious","haan bhai first time"], "react", 3, "medium", "🔥"),
    # -- Acknowledge conversations  
    (["bhai kaam ho gaya","konsa kaam","assignment submit kar di","accha","haan bhai deadline se pehle"], "acknowledge", 1, "medium", "noted done"),
    (["yaar ghar pahunch gaya","safe","haan bhai safe hun","accha","trip mast rahi"], "acknowledge", 1, "high", "glad youre safe"),
    (["bhai payment kar di","kitni","poori amount","upi se","haan bhai confirm kar le"], "acknowledge", 1, "high", "payment received"),
    # -- Translate conversations
    (["bhai ek message aaya foreign mein","kaunsi language","pata nahi","bhej dikhao","감사합니다 정말 도움이 많이 됐어요"], "translate", 5, "low", "translate:korean_text"),
    (["yaar caption mein kuch likha tha","kya","samajh nahi aaya","screenshot bhej","ありがとうございました本当に助かりました"], "translate", 5, "low", "translate:japanese_text"),
    (["bhai email aaya kisi ka","konsa email","foreign language mein hai","forward kar","Muchas gracias por tu ayuda amigo de verdad"], "translate", 5, "low", "translate:spanish_text"),
    # -- Career/life conversations
    (["bhai ek news hai","kya hua bata","bhai offer aaya hai","konsi company se","yaar FAANG se aaya hai kya karun"], "text", 5, "low", "text:big_tech_offer"),
    (["yaar soch raha hun kuch start karun","kya karna chahta","freelancing try karna hai","pehle kya karta hai","bhai step by step guide de kaise shuru karun"], "text", 5, "medium", "text:freelancing_guide"),
    (["bhai job mein bahut stress hai","kya hua office mein","boss toxic hai yaar","naukri chhod de","bhai kaise chhodum loan chal raha"], "text", 5, "low", "text:toxic_boss"),
    (["yaar salary raise maangni hai","kitni chahiye","30 percent","performance kaisa raha","accha raha bhai tips do kaise maangun"], "text", 5, "low", "text:salary_raise"),
    (["bhai resign karne ka soch raha","kyun bhai","better offer aaya hai","notice period kitna","60 din bhai kaise handle karun"], "text", 1, "medium", "text:resignation_advice"),
]
...
def build_media_sample(lang="hinglish", adversarial=False):
    """Build implicit media sample — situational context, no explicit 'send gif'."""
    # Pick random category, then random topic from it
    category = random.choice(list(MEDIA_TOPICS.keys()))
    topic = random.choice(MEDIA_TOPICS[category])
    ...
    hi_variations = [
        ...
        f"{key_msg} yaar", f"arre {key_msg}", f"oye {key_msg} bhai",
    ]
    en_variations = [
        key_msg, f"bro {key_msg}", f"omg {key_msg}",
        f"{key_msg} ngl", f"guys {key_msg}",
    ]
...
def build_react_sample(lang="hinglish", adversarial=False):
    """Build react sample — natural moment that deserves emoji reaction."""
    # Pick random emoji, then random topic for it
    emoji_reaction = random.choice(list(REACT_TOPICS.keys()))
    topic = random.choice(REACT_TOPICS[emoji_reaction])
    key_msg_base, effort = topic
...
def build_acknowledge_sample(lang="hinglish", adversarial=False):
    ...
    dec = make_decision("acknowledge", target_pos, effort, reply)
    return msgs, dec

def build_translate_sample(lang="hinglish", adversarial=False):
    topic = random.choice(TRANSLATE_TOPICS)
    foreign_text, canonical_title, effort = topic
    ...
    dec = make_decision("translate", target_pos, effort, canonical_title)
    return msgs, dec
...
def build_conversation_memory_sample(lang="hinglish"):
    """Build a coherent 5-message conversation flow from CONVERSATION_MEMORY_TOPICS."""
    topic = random.choice(CONVERSATION_MEMORY_TOPICS)
    msgs_base, typ, target_pos, effort, title = topic

    # Apply light variation to messages for diversity
    msgs = []
    for i, m in enumerate(msgs_base):
        if i != target_pos - 1:  # Don't modify the target message
            if random.random() < 0.3 and len(m.split()) > 2:
                m = apply_paraphrase(m)
        msgs.append(m)

    eff = effort if effort != "null" else "null"
    dec = make_decision(typ, target_pos, eff, title)
    return msgs, dec


def permute_context(msgs, target_index):
    """Shuffle non-target messages to create a permuted variant.
    For ignore samples (target_index is None), shuffle all messages."""
    new_msgs = list(msgs)  # copy
    if target_index is None:
        # Ignore: shuffle everything
        random.shuffle(new_msgs)
    else:
        filler_indices = [i for i in range(len(msgs)) if i != target_index]
        filler_msgs = [msgs[i] for i in filler_indices]
        random.shuffle(filler_msgs)
        for j, fi in enumerate(filler_indices):
            new_msgs[fi] = filler_msgs[j]
    return new_msgs
...
def main():
    ...
    # Inject conversation memory samples first
    memory_count = 0
    for _ in range(CONVERSATION_MEMORY_COUNT * 3):  # oversample to handle dedup
        if memory_count >= CONVERSATION_MEMORY_COUNT:
            break
        msgs, dec = build_conversation_memory_sample()
        parts = dict(p.split("=",1) for p in dec.replace("R: ","").split(" | "))
        target = parts.get("TARGET","null").replace("M","") if parts.get("TARGET","null") != "null" else None
        type_hint = parts.get("TYPE", "text")
    ...
    print(f"   Conversation memory samples: {memory_count}")
    ...
    # Strip internal fields and build compact records
    final = []
    for s in samples:
        final.append({
            "type": s["type"],
    ...
    def write_compact(samples_list, path):
        """Write samples in compact .txt format with R: prefix."""
    ...
    # Write base output (compact .txt)
    out = "dataset_v3.txt"
    write_compact(final, out)

    # ── Context Permutation Augmentation (CPA) ──
    print(f"\n{'='*60}")
    print(f"🔄 Applying Context Permutation Augmentation (CPA)...")
    print(f"   Permutations per sample: {CPA_PERMUTATIONS}")
    print(f"   Skipping conversation memory samples")

    augmented = list(final)  # start with originals
    perm_count = 0
    skipped_memory = 0

    for s in samples:
        # Skip conversation memory samples — they rely on logical flow
        if s.get("_is_memory", False):
            skipped_memory += 1
            continue

        msgs = s["_msgs"]
        target_str = s["_target"]
        typ = s["_type"]
        ...
        if target_str == "null":
            ...
            target_idx = int(target_str.replace("M", "")) - 1  # 0-indexed

        # Generate CPA_PERMUTATIONS permuted samples
        for _ in range(CPA_PERMUTATIONS):
            perm_msgs = permute_context(msgs, target_idx)

            # Skip if permutation is identical to original
            if perm_msgs == list(msgs):
                continue

            # Build new user content with permuted messages
            user_content = "\n".join(f"M{i+1}: {perm_msgs[i]}" for i in range(5))

            # Reuse original R: decision line
            orig_content = s["messages"][2]["content"]
            ...
            augmented.append({
                ...
                "messages": [
                    {"role": "system", "content": SYSTEM},
                    {"role": "user", "content": user_content},
                    {"role": "assistant", "content": orig_content},
                ],
            })
            perm_count += 1
    ...
    aug_out = "dataset_v3_augmented.txt"
    write_compact(augmented, aug_out)

    print(f"   Memory skipped: {skipped_memory}")
    print(f"   Permutations generated: {perm_count}")
    print(f"   Total augmented samples: {len(augmented)} → {aug_out}")
    print(f"   Multiplication factor: {len(augmented)/len(final):.1f}x")
    ...
    for i, s in enumerate(samples):
        raw = s["messages"][2]["content"]
        # Extract the R: decision line
        dec_lines = [l for l in raw.split("\n") if l.startswith("R: ")]
        if not dec_lines:
            errors.append(f"#{i} missing R: decision line")
            continue
        dec = dec_lines[0]
        parts = dict(p.split("=",1) for p in dec.replace("R: ","").split(" | "))
        t = parts.get("TYPE","")
    ...
    for s in samples:
        raw = s["messages"][2]["content"]
        # Extract just the R: line
        r_lines = [l for l in raw.split("\n") if l.startswith("R: ")]
        dec = r_lines[0] if r_lines else ""
